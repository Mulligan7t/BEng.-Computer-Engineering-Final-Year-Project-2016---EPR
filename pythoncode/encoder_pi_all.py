...
from time import sleep
                  ...
                  # GPIO Ports
Enc_A = 1              # Encoder input A: input GPIO 2 
Enc_B = 0                   # Encoder input B: input GPIO 3

Enc_A = 21             # Encoder input A: input GPIO 2 
Enc_B = 20                   # Encoder input B: input GPIO 3
Enc_A = 14              # Encoder input A: input GPIO 2 
Enc_B = 15                 # Encoder input B: input GPIO 3
Enc_A = 2              # Encoder input A: input GPIO 2 
Enc_B = 3                   # Encoder input B: input GPIO 3
