...
def drive(coY0, coY1, coX0, coX1):
  ...
  if (True):
    all_dir = 1
    motor_setpoint[left_front] = 50 * all_dir
    motor_setpoint[right_front] = 50 * all_dir
    motor_setpoint[left_back] = 50 * all_dir
    motor_setpoint[right_back] = 50 * all_dir
...
def main():
  ...
  global rotary_counters, lock_rotary, encoder_reading, magnetic_heading_LSM303, route_counter, ext_var, prev_time, current_time
