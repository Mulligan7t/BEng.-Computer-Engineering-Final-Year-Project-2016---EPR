...
def drive(coY0, coY1, coX0, coX1):
  global motor_setpoint, magnetic_heading_LSM303, r_var,route_counter
...
def main():
  ...
  try:  
    ...
    global rotary_counters, lock_rotary, encoder_reading, magnetic_heading_LSM303, route_counter, r_var, prev_stat, stat, prev_time, current_time
