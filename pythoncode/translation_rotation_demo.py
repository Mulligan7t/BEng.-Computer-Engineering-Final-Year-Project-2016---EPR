...
def drive(coY0, coY1, coX0, coX1):
  global motor_setpoint, magnetic_heading_LSM303, x_var,y_var,r_var,route_counter, foward_drive, drive_start_time,waypoint_time, has_done_first_heading_check
  print "Entered Drive"
  coXdiff = coX1-coX0
  coYdiff = coY1-coY0
  #print coXdiff
  ...
  angularZ = math.radians(heading_adjustment*10)


  print "magnetic_heading: ", magnetic_heading_LSM303
  print "heading_adjustment: ", heading_adjustment
  print "angularZ: ", angularZ
...
def main():
  ...
  try:  
    ...
    global rotary_counters, lock_rotary, encoder_reading, magnetic_heading_LSM303, route_counter, x_var, y_var, r_var, prev_stat, stat, prev_time, current_time
    ...
    parser.add_argument('-r_var', dest='r_var', required=False)
